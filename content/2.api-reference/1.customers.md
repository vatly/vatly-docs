...
| Name | Type | Description |
| --- | --- | --- |
| `email` | `string` | The email address for the customer. Must be unique within the storefront for the given testmode. |
...
| --- | --- | --- |
| `name` | `string \| null` | The customer's display / account-holder name (max 255 characters). |
| `email` | `string` | The customer's email address. Must be unique within the storefront for the given testmode. |
