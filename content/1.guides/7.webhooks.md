...
| Header | Purpose |
| --- | --- |
| `Vatly-Signature` | Lets you verify the delivery really came from Vatly. See [Verifying signatures](#verifying-signatures). |
