...
| `subscription.canceled_immediately` | A subscription was canceled immediately. |
...
| `one_off_product.archived` | A one-off product was archived and taken out of the sellable catalogue. `object` is the one-off product with a non-null `object.archivedAt`. |
