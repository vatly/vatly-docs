...
// Repository that owns the page being viewed (the package source repo for
// synced package pages, the core docs repo otherwise).
const source = useSourceRepo()

const editLink = computed(() => {
  // Synced package pages link straight to their source file.
  if (source.value.editUrl) {
    return source.value.editUrl
  }
