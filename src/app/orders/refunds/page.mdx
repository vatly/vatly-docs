...
These endpoints allow you to manage refunds for specific orders. For managing refunds across your entire account, see the [Refunds](/refunds) documentation. {{ className: 'lead' }}
