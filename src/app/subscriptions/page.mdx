...
<Row>
  ...
  <Col sticky>
    ...
    $subscription = $vatly->subscriptions->get('subscription_SIuAFUNKdSYHZF2w');
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    $subscriptions = $vatly->customers->subscriptions('customer_w2FZHYSdKNUFAuIS')->page();
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    $subscription = $vatly->customers->subscriptions('customer_w2FZHYSdKNUFAuIS')->get('subscription_SIuAFUNKdSYHZF2w');
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    $vatly->subscriptions->update('subscription_SIuAFUNKdSYHZF2w', [
...
<Row>
  ...
  <Col sticky>
    ...
    $subscription = $vatly->subscriptions->updateBilling('subscription_SIuAFUNKdSYHZF2w', [
        'billingAddress' => [
            'country' => 'NL',
            'streetAndNumber' => '456 New St',
            'streetAdditional' => 'Apt 789',
...
<Row>
  ...
  <Col sticky>
    ...
    $vatly->subscriptions->cancel('subscription_SIuAFUNKdSYHZF2w');
    ```
