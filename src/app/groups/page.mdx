...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://api.vatly.com/v1/groups/L7cGNIBKZiNJ6wqF \
      -H "Authorization: Bearer live_your_api_key_here"
    ```
    ...
    $vatly->groups->get('L7cGNIBKZiNJ6wqF');
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X PUT https://api.vatly.com/v1/groups/L7cGNIBKZiNJ6wqF \
      -H "Authorization: Bearer live_your_api_key_here" \
    ...
    $vatly->groups->update('L7cGNIBKZiNJ6wqF', [
      'description' => 'The finest in New York.',
    ]);
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X DELETE https://api.vatly.com/v1/groups/L7cGNIBKZiNJ6wqF \
      -H "Authorization: Bearer live_your_api_key_here"
    ```
    ...
    $vatly->groups->delete('L7cGNIBKZiNJ6wqF');
    ```
