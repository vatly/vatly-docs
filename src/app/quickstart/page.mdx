...
<CodeGroup tag="GET" label="/v1/checkouts">
...
<div className="not-prose">
  <Button href="/checkouts" variant="text" arrow="right">
    <>Read the docs for the Checkouts endpoint</>
  </Button>
</div>
...
- [Check out the Checkouts endpoint](/checkouts)
