...
<Row>
  ...
  <Col sticky>
    ...
    curl -G https://api.vatly.com/v1/attachments \
      ...
      -d checkout_id="xgQQXg3hrtjh7AvZ" \
      -d limit=10
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://api.vatly.com/v1/attachments/Nc6yKKMpcxiiFxp6 \
      -H "Authorization: Bearer live_your_api_key_here"
    ```
    ...
    $vatly->attachments->get('Nc6yKKMpcxiiFxp6');
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X PUT https://api.vatly.com/v1/attachments/Nc6yKKMpcxiiFxp6 \
      -H "Authorization: Bearer live_your_api_key_here" \
    ...
    $vatly->attachments->update('Nc6yKKMpcxiiFxp6', [
      'filename' => 'Invoice_room_service__Plaza_Hotel_updated.pdf',
    ]);
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X DELETE https://api.vatly.com/v1/attachments/Nc6yKKMpcxiiFxp6 \
      -H "Authorization: Bearer live_your_api_key_here"
    ```
    ...
    $vatly->attachments->delete('Nc6yKKMpcxiiFxp6');
    ```
