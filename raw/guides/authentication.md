...
To authenticate with the Vatly API, you need to include your API key in the `Authorization` header of each request. You can obtain your API key from the [Vatly dashboard](https://my.vatly.com) under **Developers » API keys**.
